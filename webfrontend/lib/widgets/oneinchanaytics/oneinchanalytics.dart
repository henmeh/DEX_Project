                    ...
                    ? Row(
                        children: [
                          ...
                          Container(
                            ...
                            width: 300,
                            child: ListTile(
                              leading: swapsnapshot.data[3]["logoURI"] != ""
                                  ? Tokensymbols(
                                      height: 25,
                                      width: 25,
                                      image: swapsnapshot.data[3]["logoURI"])
                                  : Text(""),
                              title: Text(swapsnapshot.data[3]["symbol"],
                                  style: TextStyle(
                                      color: Theme.of(context).highlightColor)),
                            ),
                          ),
                    ...
                    ? Row(
                        children: [
                          ...
                          Container(
                            ...
                            width: 300,
                            child: ListTile(
                              leading: swapsnapshot.data[4]["logoURI"] != ""
                                  ? Tokensymbols(
                                      height: 25,
                                      width: 25,
                                      image: swapsnapshot.data[4]["logoURI"])
                                  : Text(""),
                              title: Text(swapsnapshot.data[4]["symbol"],
                                  style: TextStyle(
                                      color: Theme.of(context).highlightColor)),
                            ),
                          ),
